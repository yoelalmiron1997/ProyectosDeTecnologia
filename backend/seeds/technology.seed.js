//configuramos la conexion a mongoose para insertar
//invoco mongoose, nodejs hace un singleton y hace la misma instancia por mas que invoquemos consts mongoose siempre.

const mongoose = require("mongoose");
const {MONGO_URI} = require ("../config");
const { Technology } = require("../models"); //{ Technology } esto viene del modelo
...
//uso el modelo technology y nos devuelve un promise(usamos un then y catch)

Technology.create(technologies).then(()=>{
    console.log("Technologies Created");
    mongoose.disconnect(); //Me desconecto
